import { MyActiveListingsService, getCreatedDataProductsQuery } from './my-active-listings.service';
...
describe('MyActiveListingsService', () => {
  let service: MyActiveListingsService;
  ...
  beforeEach(() => {
    ...
    service = new MyActiveListingsService(
    ...
    it('should fetch DataProducts with proper query', () => {
      return new Promise(resolve => {
        ...
        expect(dataProductListServiceSpy.getDataProducts.calls.allArgs()[ 0 ][ 0 ])
          .toEqual(getCreatedDataProductsQuery(wallet.address));
      });
    });
  });
