...
import { DataProductOrder as BlockchainDataProductOrder, TransactionReceipt, TransactionStatus } from '@repux/repux-web3-api';
...
describe('MarketplaceFinaliseButtonComponent', () => {
  ...
  beforeEach(fakeAsync(() => {
    ...
    walletServiceSpy.getWallet.and.returnValue(from(Promise.resolve(new Wallet(sellerAddress, new BigNumber(1), new BigNumber(1)))));
